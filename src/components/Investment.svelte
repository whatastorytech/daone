	...
	<div class="container mx-auto">
		<div class="space-y-16">
			...
			<div class="grid grid-cols-3 gap-8 px-32 [&>div]:space-y-3 [&>div]:border [&>div]:border-blue-50/20 [&>div]:rounded-md [&>div]:p-8">
				<div>
					<h3 class="text-white text-xl font-medium font-cg">Co-Investments & Partnerships</h3>
				...
				<div>
					<h3 class="text-white text-xl font-medium font-cg">Direct Sourcing</h3>
					<p class="text-lg leading-7">
				...
				<div>
					<h3 class="text-white text-xl font-medium font-cg">Community Building</h3>
					<p class="text-lg leading-7">
