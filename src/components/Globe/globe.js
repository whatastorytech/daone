  ...
  */
	...
	function setupScene() {
		...
		var canvasResizeBehaviour = function () {
			container.width = window.innerWidth / 1.2;
			container.height = window.innerHeight / 1.2;
			container.style.width = window.innerWidth / 1.2 + 'px';
			container.style.height = window.innerHeight / 1.2 + 'px';
